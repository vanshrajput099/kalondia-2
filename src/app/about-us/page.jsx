        ...
        <div>
            ...
            <div className="relative h-[300px] w-full">
                ...
                <div className="space-y-4 absolute inset-0 flex flex-col items-center justify-center text-center text-white w-[50%] mx-auto">
                    <h1 className="text-[#6224A9] text-4xl font-semibold">Culture</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Beatae deserunt pariatur iure doloribus consequuntur ipsam similique, blanditiis dignissimos vitae distinctio.</p>
                </div>
            </div>
            <div className='w-[40%] text-center mx-auto py-20'>
                <h1 className='text-4xl text-[#6224A9] font-medium'>Focus</h1>
