...
export async function POST(req) {
    try {
        ...
        if ([firstName, lastName, email, phone].some(ele => !ele || ele.trim() === "")) {
        ...
        try {
            const res = await resend.emails.send({
                ...
                subject: '📩 New Media Contact Request',
                html: `
<div style="font-family: 'Helvetica', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px; background-color: #f9f9f9;">
    <h2 style="color: #2c3e50; border-bottom: 2px solid #e0e0e0; padding-bottom: 10px;">📩 New Media Contact Request</h2>
