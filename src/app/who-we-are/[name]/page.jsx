...
const page = async ({ params }) => {
    ...
    return (
        <div>
            ...
            <div className='w-[60%] mx-auto py-30'>
                <h1 className='text-4xl text-[#6224A9] font-medium'>{paramsNames.name}</h1>
                ...
                <div className='mt-20'>
                    <Link href={"/who-we-are"} className='bg-[#6224A9] text-white px-6 py-4 rounded-lg text-sm'>
